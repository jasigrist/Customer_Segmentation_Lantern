...
# %%
def validation_kMeans(train_data1, train_data2, dataset):
    seed_random = 42
    ...
    plt.legend()
    plt.grid(False)
    plt.savefig(f"/Users/jansigrist/Documents/SP/Customer_Segmentation_Lantern/Results/{dataset}/Plots/Cluster/KMeans_Silhouette.png", bbox_inches='tight')
    plt.show()
