...
def plot_cluster_percentiles(train_data, clusters_train, n_clusters, building_type, dataset):
    ...
    plt.savefig(f'/Users/jansigrist/Documents/SP/Customer_Segmentation_Lantern/Results/{dataset}/Plots/Cluster/HourlyAveraged_percentiles_KMeans_{building_type}.png',
                bbox_inches='tight')
    plt.show()
